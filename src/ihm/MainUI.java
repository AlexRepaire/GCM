...
public class MainUI extends JFrame {
	...
	String[] colonnes = { "Nom", "PrÃ©nom", "Adresse", "NumÃ©ro SÃ©cu", "Age", "Ville" };
	...
	public static void main(String[] args) {
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (patientDaoJDBC.findUserByUsernameAndPassword(user, finalPwd)==true) {
					frame.setVisible(true);
					jdialog.setVisible(false);
				} else {
					JOptionPane.showMessageDialog(frame, "Veuillez ressayer encore une fois", "Erreur",
...
//		});
	...
	public MainUI() {
		...
		comboBoxVille.addItem("CondÃ© sur Escaut");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(MainUI.this, "Ajout rÃ©alisÃ©", "SuccÃ¨s",
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (row == -1) {
					...
					JOptionPane.showMessageDialog(null, "Veuillez sélectionner un patient", "Attention",
					...
					jDialogUpdate.setBounds(200, 200, 800, 400);
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int row = table.getSelectedRow();
				if (row == -1) {
					JOptionPane.showMessageDialog(null, "Veuillez selectionner un patient", "Attention",
							JOptionPane.WARNING_MESSAGE);
		...
		lblNewLabel_6 = new JLabel("Adressel");
		lblNewLabel_6.setBounds(184, 53, 41, 14);
		panelModification.add(lblNewLabel_6);

		textAreaAdrEdit.setBounds(256, 50, 195, 73);
		panelModification.add(textAreaAdrEdit);

		JLabel lblNewLabel_7 = new JLabel("Ville");
		lblNewLabel_7.setBounds(182, 171, 46, 14);
